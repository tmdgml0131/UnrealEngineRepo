...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets_Inner = { "CharacterAssets", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets = { "CharacterAssets", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UABCharacterSetting, CharacterAssets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Git_UnrealEngineRepo_ArenaBattle_Source_ArenaBattleSetting_Public_ABCharacterSetting_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_UnrealEngineRepo_ArenaBattle_Source_ArenaBattleSetting_Public_ABCharacterSetting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABCharacterSetting, UABCharacterSetting::StaticClass, TEXT("UABCharacterSetting"), &Z_Registration_Info_UClass_UABCharacterSetting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABCharacterSetting), 4011088764U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_UnrealEngineRepo_ArenaBattle_Source_ArenaBattleSetting_Public_ABCharacterSetting_h_4060140385(TEXT("/Script/ArenaBattleSetting"),
		Z_CompiledInDeferFile_FID_Git_UnrealEngineRepo_ArenaBattle_Source_ArenaBattleSetting_Public_ABCharacterSetting_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_UnrealEngineRepo_ArenaBattle_Source_ArenaBattleSetting_Public_ABCharacterSetting_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
