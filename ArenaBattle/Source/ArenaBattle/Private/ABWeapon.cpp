...
void AABWeapon::BeginPlay()
{
	...
	AttackModifer = FMath::RandRange(AttackModifierMin, AttackModiferMax);
	ABLOG(Warning, TEXT("Weapon Damage: %f, Modifier: %f"), AttackDamage, AttackModifer);
